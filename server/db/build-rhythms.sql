...
INSERT INTO rhythms (rhythm_code_id, rhythm, video, audio, image, description, language, year_start, year_end) VALUES(2, 'Mende', NULL, 'https://drive.google.com/file/d/1QZXyjQSpEX8_QG1C-fqs_CUs5-YWRpzM/view?usp=sharing', NULL, 'The mendé would have been the last rhythm to arrive in the islands, with the "Congos" under contract after the abolition, and symbolises the collective celebration of carnival', 'French', 1850, 2020);
...
INSERT INTO rhythms (rhythm_code_id, rhythm, video, audio, image, description, language, year_start, year_end) VALUES(2, 'Lewoz', NULL, 'https://drive.google.com/file/d/1MWSjabKTaaEqGInaT5fMm62jtD1VkC4n/view?usp=sharing', NULL, 'The léwôz is the war rhythm, used to give rhythm the attacks against the plantations, but was also an incantation dance', 'French', 1700, 2020);
INSERT INTO rhythms (rhythm_code_id, rhythm, video, audio, image, description, language, year_start, year_end) VALUES(2, 'Toumblak', NULL, 'https://drive.google.com/file/d/1nWHAXNfjgWgYNCInWlgTJ5GLZ8NAUNGX/view?usp=sharing', NULL, 'The toumblak, like the kaladja, deals with the love theme, belly dance, fertility dance', 'French', 1700, 2020);
INSERT INTO rhythms (rhythm_code_id, rhythm, video, audio, image, description, language, year_start, year_end) VALUES(2, 'Woule', NULL, 'https://drive.google.com/file/d/1Ra1GPt-9L1pC4wKtuKvKSN-kvq4Bt_H5/view?usp=sharing', NULL, NULL, NULL, 1700, 2020);
...
INSERT INTO rhythms (rhythm_code_id, rhythm, video, audio, image, description, language, year_start, year_end) VALUES(6, 'Ring shout ', NULL, 'https://drive.google.com/file/d/1EIHPTcqWC69PqaGHuMpb_5fa4vOOxboP/view?usp=sharing', NULL, 'Tresillo rhythm dominates, amid polyrhythms in claps and vocal. Continuity with African culture in the unity dance and music, also the unity of lyric imagery with embodied dance gestures/storytelling. Ring Shout Audio Credits:
...
INSERT INTO rhythms (rhythm_code_id, rhythm, video, audio, image, description, language, year_start, year_end) VALUES(7, 'Sanja', NULL, 'https://drive.google.com/file/d/11kaBHJ5iwMoz9o4JoQNrVJSh-8t-KT83/view?usp=sharing', NULL, 'Malinke rhythm, performed by Karamoko Sanogo. Producer/copyright: Deirdre Molloy. Informed by workshops attended with Karamoko Kone and Amelie Ferreol.', NULL, 1600, 2020);
INSERT INTO rhythms (rhythm_code_id, rhythm, video, audio, image, description, language, year_start, year_end) VALUES(8, 'Numudon', NULL, 'https://drive.google.com/file/d/1pxGkUf3_f9kUZTZROJRjPEpvj2I-A3tW/view?usp=share_link', NULL, 'Don=danse Numuw = metal smiths. Danse des forgerons (numuw) traditionally danced with a hatchet or a scarf in the hands. Malinke rhythm of iron-smiths, performed on multiple drums and bells by Karamoko Sanogo. Producer/copyright: Deirdre Molloy. Informed by workshops attended with culture bearers: Dramane & Manu Sissoko (Mali).', NULL, 1600, 2020);
INSERT INTO rhythms (rhythm_code_id, rhythm, video, audio, image, description, language, year_start, year_end) VALUES(8, 'Balakulandya', NULL, 'https://drive.google.com/file/d/1AjPlAngGsHw_IJ_i1eZqvMzve7jpKiC-/view?usp=share_link', NULL, 'A harvest ritual rhythm: Source: Guinea style w Karamako Kone and Melissa Habibi.', NULL, 1600, 2020);
INSERT INTO rhythms (rhythm_code_id, rhythm, video, audio, image, description, language, year_start, year_end) VALUES(9, 'Koroduga', NULL, 'https://drive.google.com/file/d/17-_jYu8YpLJ7Xp6n55FIc6BPZeFuWxIz/view?usp=share_link', NULL, 'Bambara peoples: Male secret society version> female version > bamako theatre version. Original male only version has "Komo" mask. Informed by workshops attended with culture bearers : Brahima dit Bandjouguou Coulibaly dancer, percussion: Kako Kone and Aruna Kone. Tansolé: dance Gaelle Roussillon & djembe: Kako Kone. This performance, all drums performed by Karamoko Sanogo. Producer/copyright: Deirdre Molloy. ', NULL, 1600, 2020);
...
INSERT INTO rhythms (rhythm_code_id, rhythm, video, audio, image, description, language, year_start, year_end) VALUES(9, 'Chi Wara', NULL, NULL, 'https://drive.google.com/file/d/1DQWSIyUbAAnBwimjt_SOJF6XA1IKSGHW/view?usp=sharing', 'Yes', NULL, 1600, 2020);
