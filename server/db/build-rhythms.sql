...
INSERT INTO rhythm_codes (rhythm_code, location, region, map_id) VALUES('Baulé', 'Agni', 'Ivory Coast, Togo, Benin, Ghana', 'dot2075');
INSERT INTO rhythm_codes (rhythm_code, location, region, map_id) VALUES('Akan', 'Agni', 'Ivory Coast, Togo, Benin, Ghana', 'dot1702');
INSERT INTO rhythm_codes (rhythm_code, location, region, map_id) VALUES('Manding', 'Mande Empire  (Mali, Ivory Coast, Burkina Faso, Guinea, Senegambia)', 'West Africa', 'dot1877');
...
INSERT INTO rhythms (rhythm_code_id, rhythm, video, audio, image, description, language, year_start, year_end) VALUES(5, 'DC Hand Dancing', 'https://youtu.be/l4AIRnhM3JM?si=EBb96_lweMANpkgH', NULL, NULL, NULL, NULL, 1920, 1960);
INSERT INTO rhythms (rhythm_code_id, rhythm, video, audio, image, description, language, year_start, year_end) VALUES(6, 'Ring shout ', 'https://vimeo.com/1009679082?fl=pl&fe=vl&pgroup=plv', '/assets/audio/ring_shout.mp3', NULL, 'Tresillo rhythm dominates, amid polyrhythms in claps and vocal. Continuity with African culture in the unity dance and music, also the unity of lyric imagery with embodied dance gestures/storytelling. Ring Shout Audio Credits:
...
INSERT INTO rhythms (rhythm_code_id, rhythm, video, audio, image, description, language, year_start, year_end) VALUES(11, 'Abodan', 'https://www.youtube.com/watch?v=TwqLOKlTWow&t=5s', NULL, NULL, 'This video was selected from YouTube by djembefola Karamoko Kone as an example of Akan ancestral dance, in an interview in 2021. He said that the low torso and vibrating footwork of Akan dance honors ancestors in the earth, and is ‘feline’ as it belongs in the forest. This animist interpretation of the dance aesthetic is supported by a BBC documentary (2014) where Asante cosmology was identified with sacred forest sites where ancestral spirits resided in the earth.

Despite poor image quality, the second video shows high level of embodied skill in the ancestral African cipher or circle – each dancer enter the circle to dialogue with the drummer. Their aesthetics are consistent, even as each individual’s expression of the code is celebrated. To map high quality video of Abodan and many other amazing dances of West Africa is long overdue and is one of our long-term goals. Equally motivated to honor and transmit rhythm heritage, Clement Assemian is seeking support to establish an Akan dance Conservatory in Cote d’Ivoire.', NULL, 1600, 2020);
...
INSERT INTO rhythms (rhythm_code_id, rhythm, video, audio, image, description, language, year_start, year_end) VALUES(12, 'Koréduga', 'https://youtu.be/sxgR25lf3dA?si=a9gOWk6IQIK_SoMB', NULL, NULL, 'This step is part of a wider reperoire of Koredouga steps. Practising this slower, hip-swinging step, we find a lineage with Afro-diasporic dances. The torso isolation and hip swing of this step continue from African dance into the American Blues step ‘Four Corners’ – danced in couple and solo. The same hip-swing-step body mechanics (minus the swinging arms) creates the Jamaican dancehall step Log On. The American/Caribbean step is typically danced in place, rather than travelling. The music that carries this step in the America varies, but is often the Africanist rhythm known as tresillo / Dembow. This is the implied rhythm marked by our feet and by the hip and arm swing in this video.', NULL, 1600, 2020);

INSERT INTO rhythms (rhythm_code_id, rhythm, video, audio, image, description, language, year_start, year_end) VALUES(12, 'Djondon', NULL, NULL, NULL, 'From the era of the Mandingue empire: dance of the enslaved (djon) captives or their children “wolosso”. Wolosso meaning “born here /at home” were free, but occupied the lowest caste, below families of skills such as smithing, nobles (landlords?) and royalty. Formation: drum-dance dialogue/circle, also some motifs are performed on all-fours, shaking the torso and head. At ritual events to this day, djondon also refers to ‘le bouffon’ a mocking, clowning performance: teasing guests with sheep’s testicles filled with water and exaggerated phallic toys – to escape them you give a coin. From JS Bourget: WOLOSO ( fast = SUKU family) – no dance video “The Manden societies were (and still are to a certain extent) organized according to very distinct classes: the nobles, traditionally practicing agriculture, war and trade; caste people practicing trades considered impure: blacksmiths, tanners, griots, etc …; finally, at the bottom of the scale: the woloso, descendants of slaves (woloso literally meaning ‘born at home’ as opposed to captives called ‘djon’; some woloso could access important responsibilities). As in other cultures, the possibility of expressing feelings is inversely proportional to social rank, and by Sega’s own admission, the woloso dance is ‘not very polite’.” JS Bourget http://www.baaraniogonya.com', NULL, 1600, 2020);
